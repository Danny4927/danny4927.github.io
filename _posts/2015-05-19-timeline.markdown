...
Wie ihr vielleicht schon unter [About Me]({{ site.baseurl }}/about.html)gesehen habt, habe ich dort einen Zeitstrahl eingefügt. Wie das funktioniert werde ich euch in diesem Post erklären. 
